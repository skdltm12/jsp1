...
<form action="EditNoticeCtrl" method="post">
	...
	%>
			...
			<tr>
				<th>내용</th>
				<td><textarea name="ncontent" cols="100" rows="5"><%=vo.getNconetnt() %></textarea></td>
			</tr>
			<tr>
				<th>추가 이미지</th>
			...
			<tr>
				<th>첨부 자료</th>
				<td><input type="file" name="ndata" value="<%=vo.getNdata() %>"></td>
			</tr>
			<tr>
				<th>작성일</th>
				<td><%=vo.getResdate() %></td>
			...
			<tr>
				<td colspan="2">
					...
					<a href="/web2/GetNoticeListCtrl" class="frm_btn">목록</a> &nbsp; &nbsp; &nbsp; &nbsp;
					<a href="/web2/DelNoticeCtrl?nno=<%=vo.getNno() %>" class="frm_btn">삭제</a>
				</td>
			</tr>
	<%
		}
