...
<form action="/web02/EditUserCtrl" method="post">
	...
	%>
			...
			<tr>
				<th>비밀번호</th>
				<td><input type="text" name="upw" value="<%=cus.getUpw() %>"></td>
			</tr>
			<tr>
				<th>고객명</th>
				<td><input type="text" name="uname" value="<%=cus.getUname() %>"></td>
			</tr>
			<tr>
				<th>전화번호</th>
				<td><input type="tel" name="tel" value="<%=cus.getTel() %>"></td>
			</tr>
			<tr>
				<th>이메일</th>
			...
			<tr>
				<td colspan="2">
					...
					<a href="/web2/GetMypageCtrl">마이페이지</a> &nbsp; &nbsp; &nbsp; &nbsp;
					<a href="/web2/DelUserCtrl">탈퇴</a>
				</td>
			</tr>
	<%
		}
