...
%>
	...
	<nav id="tnb">
		...
		<% } else if(sid.equals("admin")) { %>
			...
			<li><a href="/web2/GetCustomerListCtrl">고객 목록</a></li>
			<li><a href="/web2/GetTourListCtrl">방문지 목록</a></li>
			<li><a href="/web2/GetNoticeListCtrl">공지사항 목록</a></li>
			<li><a href="/web2/GetImpressionListCtrl">이용후기 목록</a></li>
			<li><a href="/web2/LogoutCtrl">로그아웃</a></li>
		<% } else { %>
			<li><span><%=sname %></span></li>
			<li><a href="/web2/GetMypageCtrl">마이페이지</a></li>
			<li><a href="/web2/GetUserCtrl">정보수정</a></li>
			<li><a href="/web2/LogoutCtrl">로그아웃</a></li>
		<% } %>
		</ul>
	</nav>
